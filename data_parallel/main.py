...
trainset = torchvision.datasets.CIFAR10(
    root=PATH_DATASETS, train=True, download=False, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(
    root=PATH_DATASETS, train=False, download=False, transform=transform_test)
    ...
    with tqdm(trainloader, unit='brach') as tepoch:
        for batch_idx, (inputs, targets) in enumerate(tepoch):
            ...
            tepoch.set_postfix(loss=train_loss/(batch_idx+1),
                               accuracy='Acc: %.3f%% (%d/%d)' % (100.*correct/total, correct, total))
